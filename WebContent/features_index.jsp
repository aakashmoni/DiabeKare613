...
Alarms
<p>
These should sound when:<br>

the device is disconnected.<br>
the device is not switched to suspend.€<br>
a meal time has passed and no bolus was recorded.<br>
Activate is not used for an intended bolus.<br>
